...
APP_PUBLIC_KEY = b"key" if os.environ.get('APP_PUBLIC_KEY') is None else bytes(os.environ.get('APP_PUBLIC_KEY').replace('\\n', '\n'), 'UTF-8')
APP_PRIVATE_KEY = b"key" if os.environ.get('APP_PRIVATE_KEY') is None else bytes(os.environ.get('APP_PRIVATE_KEY').replace('\\n', '\n'), 'UTF-8')
