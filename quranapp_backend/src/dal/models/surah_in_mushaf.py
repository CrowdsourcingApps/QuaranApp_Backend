...
class SurahInMushaf(Base):
    ...
    mushaf_pages = relationship("MushafPage", back_populates="surah_in_mushaf")
    surah = relationship("Surah", back_populates="surah_in_mushaf")
