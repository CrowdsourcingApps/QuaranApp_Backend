...
def upgrade() -> None:
    ...
    op.create_index('ix_ayah_parts_part_number', 'ayah_parts', ['part_number'], unique=False)
    ...
    op.create_index('ix_mushafs_publisher_riwayah', 'mushafs', ['publisher', 'riwayah'], unique=True)
...
def downgrade() -> None:
    ...
    op.drop_index('ix_mushafs_publisher_riwayah', table_name='mushafs')
    ...
    op.drop_index('ix_ayah_parts_part_number', table_name='ayah_parts')
    # ### end Alembic commands ###
